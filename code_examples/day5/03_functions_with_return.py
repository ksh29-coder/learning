...
# Challenge ideas:
# 1. Write a triple(n) function that returns n * 3.
# 2. Write a divide(a, b) function that returns a / b.
# 3. Remember: return SENDS BACK the answer, print just SHOWS it.
#    Try returning a value and printing it in two separate steps!
