...
function Day2Part5({ answers, updateAnswer }) {
  const reflectionQuestions = [
    { key: 'reflection1', label: '1. A variable is:' },
    { key: 'reflection2', label: '2. The difference between a string and a number is:' },
    { key: 'reflection3', label: '3. The input() function is used to:' },
